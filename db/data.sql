...
--Route
INSERT INTO route
(id, departure_day, departure_time, hours, is_departure, home_warehouse_id, away_warehouse_id, vehicle_id)
VALUES
    (1,0, '13:00',1,true,1,2,1),
    (2,1, '10:00',1,false,1,2,1),
    (3,2, '8:00',1,true,3,2,4),
    (4,2, '13:00',1,false,3,2,4),
    (5,2, '8:00',1,true,1,3,2),
    (6,2, '13:00',1,false,1,3,2),
    (7,3, '6:00',4,true,2,20,3),
    (8,4, '6:00',4,false,2,20,3),
    (9,0, '6:00',4,true,2,25,3),
    (10,0, '15:00',4,false,2,25,3),
    (11,1, '6:00',2,true,2,11,3),
    (12,2, '6:00',2,false,2,11,3),
    (13,3, '6:00',2,true,1,4,1),
    (14,3, '12:00',2,false,1,4,1),
    (15,5, '12:00',2,true,3,12,4),
    (16,6, '6:00',3,false,3,12,4),
    (17,2, '6:00',3,true,4,5,5),
    (18,2, '12:00',3,false,4,5,5),
    (19,4, '15:00',2,true,4,6,5),
    (20,5, '5:00',2,false,4,6,5),
    (21,0, '6:00',5,true,5,27,6),
    (22,1, '5:00',5,false,5,27,6),
    (23,3, '6:00',3,true,5,8,6),
    (24,3, '12:00',3,false,5,8,6),
    (25,3, '6:00',3,true,6,8,7),
    (26,3, '12:00',3,false,6,8,7),
    (27,2, '6:00',2,true,7,8,31),
    (28,2, '12:00',2,false,7,8,31),
    (29,4, '6:00',2,true,7,8,31),
    (30,4, '12:00',2,false,7,8,31),
    (31,1, '6:00',2,true,8,9,8),
    (32,1, '12:00',2,false,8,9,8),
    (33,5, '12:00',3,true,8,10,9),
    (34,6, '6:00',3,false,8,10,9),
    (35,2, '6:00',2,true,9,12,10),
    (36,2, '12:00',2,false,9,12,10),
    (37,3, '6:00',2,true,10,13,11),
    (38,3, '12:00',2,false,10,13,11),
    (39,5, '6:00',1,true,10,12,11),
    (40,5, '12:00',1,false,10,12,11),
    (41,0, '6:00',2,true,11,16,12),
    (42,0, '12:00',2,false,11,16,12),
    (43,1, '6:00',2,true,12,13,13),
    (44,1, '12:00',2,false,12,13,13),
    (45,1, '15:00',2,true,13,11,14),
    (46,2, '6:00',2,false,13,11,14),
    (47,6, '6:00',2,true,14,2,15),
    (48,6, '12:00',2,false,14,2,15),
    (49,6, '6:00',2,true,15,17,16),
    (50,6, '12:00',2,false,15,17,16),
    (51,3, '6:00',2,true,15,1,16),
    (52,3, '12:00',2,false,15,1,16),
    (53,0, '12:00',2,true,16,14,17),
    (54,0, '15:00',2,false,16,14,17),
    (55,2, '5:00',2,true,17,20,18),
    (56,2, '11:00',2,false,17,20,18),
    (57,2, '5:00',2,true,18,19,19),
    (58,2, '11:00',2,false,18,19,19),
    (59,5, '6:00',4,true,18,25,19),
    (60,5, '15:00',4,false,18,25,19),
    (61,1, '6:00',1,true,19,20,20),
    (62,1, '10:00',1,false,19,20,20),
    (63,5, '12:00',2,true,20,23,21),
    (64,6, '6:00',2,false,20,23,21),
    (65,1, '6:00',3,true,20,22,22),
    (66,1, '10:00',3,false,20,22,22),
    (67,0, '6:00',3,true,21,20,23),
    (68,0, '15:00',3,false,21,20,23),
    (69,3, '6:00',5,true,23,24,25),
    (70,5, '6:00',5,false,23,24,25),
    (71,6, '6:00',6,true,24,25,26),
    (73,0, '6:00',6,false,24,25,26),
    (74,3, '6:00',5,true,25,4,27),
    (75,4, '6:00',5,false,25,4,27),
    (76,4, '6:00',3,true,26,27,28),
    (77,4, '12:00',3,false,26,27,28),
    (78,0, '6:00',6,true,27,8,29),
    (79,0, '15:00',6,false,27,8,29),
    (80,3, '6:00',8,true,27,25,30),
    (81,4, '6:00',8,false,27,25,30),
    (82,1, '6:00',3,true,27,26,30),
    (83,1, '12:00',3,false,27,26,30);
